/* SAARVIX compiled-Tailwind config for Authly.
   Ported from the saarvix-ui skill's tw-config.js: maps SAARVIX semantic
   tokens onto Tailwind utilities (bg-primary, text-muted-foreground,
   border-border, opacity variants) and clamps corners to ≤8px. */
